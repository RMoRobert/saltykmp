...
/** One labelled fact, with the "3 days ago" reading under it when there is a date to place. */
 ...
 * last made. Called "Get info" rather than "Info…" because that is the name of the command on the
 ...
 *
 * Last made is *shown* here and *set* from the Last prepared menu next door, which is where the CMP and
 ...
 * reload; this one is about a recipe, and a recipe is not addressable either, so the hash would
 * restore a panel with nothing behind it.
 */
export default function RecipeInfoDialog({ recipe, onClose }) {
          ...
          <DialogContent>
            <div className={styles.body}>
              <div className={styles.kv}>
                ...
                />
                {/* A day, not a moment: "last made" is a date someone picked off a calendar, and
              ...
              {/* Rarely wanted, so collapsed -- the same treatment About gets at the foot of
                  Settings. It is here at all because the three separate stamps are what explain
                  why setting a last-made date left Modified where it was. */}
                ...
                <AccordionItem value="sync">
                  ...
                  <AccordionPanel>
                    ...
                    <div className={mergeClasses(styles.kv, styles.syncKv)}>
                      ...
                      <Fact styles={styles} label="Last made" value={preparedStamp || "Never set"} />
                    </div>
                  </AccordionPanel>
                </AccordionItem>
              </Accordion>
